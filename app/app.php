...
تهران، چهارراه ولی عصر، روبه‌روی خیابان بزرگمهر، دانشگاه صنعتی امیرکبیر ، دانشکده مهندسی کامپیوتر و فناوری اطلاعات ، دفتر انجمن علمی
	...
	<br>
     در صورت تمایل به ایجاد هرگونه تغییر در وضعیت ثبت نام خودتون از ثبت نام مجدد <b> جدا خودداری فرمایید. در غیر اینصورت ثبت نام شما تایید نخواهد شد. می توانید این تغییرات را از دو طریق ۱ - ایمیل جشنواره hello@linuxfest.ir و یا ۲ - مراجعه ی حضوری اعلام فرمایید.
